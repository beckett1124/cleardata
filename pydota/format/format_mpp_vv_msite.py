...
# encoding: utf-8
"""
Brief  : format mpp_vv_msite class
...
class MppVVMSiteFormat(FormatBase):
    """
    mpp_vv_msite
    """
    def __init__(self, recv_time, topic_name='mpp_vv_msite'):
        super(MppVVMSiteFormat, self).__init__(recv_time)
...
if __name__ == '__main__':
    ...
    mpp_vv_msite_client = MppVVMSiteFormat(start_time)
    for line in fileinput.input(sys.argv[2:]):
        res = mpp_vv_msite_client.processFormat(line)
        # print res[0]
        # print res[1]
