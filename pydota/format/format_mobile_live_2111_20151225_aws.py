...
# encoding: utf-8
"""
Brief  : format mobile_live_2111_20151225_aws class
...
class MobileLive2111AwsFormat(FormatBase):
    """
    mobile_live_2111_20151225_aws
    """
    def __init__(self, recv_time, topic_name='mobile_live_2111_20151225_aws'):
        super(MobileLive2111AwsFormat, self).__init__(recv_time)
...
if __name__ == '__main__':
    ...
    mobile_live_2111_aws_client = MobileLive2111AwsFormat(start_time)
    for line in fileinput.input(sys.argv[2:]):
        res = mobile_live_2111_aws_client.processFormat(line)
        # print res[0]
        # print res[1]
