...
class MacPvFormat(FormatBase):
    """
    mac_pv
    """
    def __init__(self, recv_time, topic_name='mac_pv'):
        super(MacPvFormat, self).__init__(recv_time)
...
if __name__ == '__main__':
    ...
    mac_pv_client = MacPvFormat(start_time)
    for line in fileinput.input(sys.argv[2:]):
        res = mac_pv_client.processFormat(line)
        # print res[0]
        # print res[1]
