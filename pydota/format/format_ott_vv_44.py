...
class OttVV44Format(FormatBase):
    """
    ott_vv_44
    """
    def __init__(self, recv_time, topic_name='ott_vv_44'):
        super(OttVV44Format, self).__init__(recv_time)
...
if __name__ == '__main__':
    ...
    ott_vv_44_client = OttVV44Format(start_time)
    for line in fileinput.input(sys.argv[2:]):
        res = ott_vv_44_client.processFormat(line)
        # print res[0]
        # print res[1]
