...
./service/script/py_dota_report_live_vv_detail_hour.sh pcweb ${start_time} &
./service/script/py_dota_report_live_vv_detail_hour.sh pcclient ${start_time} &
./service/script/py_dota_report_live_vv_detail_hour.sh android ${start_time} &
./service/script/py_dota_report_live_vv_detail_hour.sh iphone ${start_time} &
./service/script/py_dota_report_live_vv_detail_hour.sh ipad ${start_time} &
./service/script/py_dota_report_live_vv_detail_hour.sh ott ${start_time} &
./service/script/py_dota_report_live_vv_detail_hour.sh macclient ${start_time} &
