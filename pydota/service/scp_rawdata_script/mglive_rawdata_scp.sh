#!/bin/sh
# mglive rawdata日志检验的topic名称
topics=("mgliveaphone_vodplay mgliveaphone_auplay mgliveaphone_rmplay mgliveiphone_vodplay mgliveiphone_auplay mgliveiphone_rmplay")
...
mglive_rawdata_check_path="/home/dota/data/mglive_rawdata_check/"
...
echo "start check mgliverawdata,date:${start_time}"
for topic in ${topics};do
    ...
    # des scp
    cp_file_name="*_mgliverawdata_${topic}_${start_time}00"
...
if [ ${cp_flag} -eq 0 ];then
    ...
    done_file=".${start_time}_mgliverawdata.done"
...
echo "end check mgliverawdata,date:${start_time}"