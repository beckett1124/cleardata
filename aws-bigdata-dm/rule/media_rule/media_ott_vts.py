...
class MediaOttVts(rule):
    """
    :换算规则
    """

    def __init__(self):
        super(MediaOttVts, self).__init__()
    ...
    def convert(self, field):
        ...
        # 长度为5，走5.0媒资逻辑
            ...
            if clientver.startswith("5."):
                return media_vrs_vid_map_client.get_vts_by_vid([vid])
            else:
        ...
        return ott_file_id_map_client.get_vts_by_vid(res[1])
