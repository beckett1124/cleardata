#encoding: utf-8
# @Author: jeffrey
# @Date:   2016-05-19T21:02:31+08:00
# @Last modified by:   jeffrey
# @Last modified time: 2016-05-20T18:18:14+08:00
    ...
    def convert(self,fields):
        ...
        if len(fields)!=2:
            ...
            if fields[0] is None or fields[0]=="":
                ...
                _res_cpn=dist_mac_page_type.get(fields[0])
                if _res_cpn is None or _res_cpn=="":
                    return [0,"未知"]
                else:
                    _res_cpn_type_id=dist_mac_page_id.get(fields[0])
